...
@section('contents')
    ...
    <div class="px-8 py-10 bg-[#FFDB89] mx-[6.4vw] mb-10 rounded-md shadow-2xl">
        <form action="/register" method="post" class="mx-4">
            ...
            @error('Nama')
                <div class="text-sm font-thin text-red-500">Minimal 2 karakter untuk Nama</div>
            @enderror
            ...
            @error('password')
                <div class="text-sm font-thin text-red-500">Minimal 5 karakter untuk Password</div>
            @enderror
            {{-- <div class="mb-2">
            ...
            <div class="relative mt-3 mb-3 inputForm " data-te-input-wrapper-init>
                <input type="number" name="Nohp" required value="{{ old('Nohp') }}"
