...
<div class="container-md mx-auto flex flex-col items-center mt-[48px] w-full">
    ...
    <div class="flex flex-row justify-center items-center gap-[5vw] w-full p-[2vw]">
        ...
        <div class="flex w-[50%]">
            <div class="relative w-full">
                <input type="search" id="location-search" class="block p-[1vw] w-full z-20 text-sm text-black bg-white focus:ring-[#DC0000] rounded-[10px] border border-2 border-[#DC0000] focus:border-[#DC0000]" placeholder="Search for city or address" required>
                <button type="submit" class="absolute top-0 right-0 p-[1vw] text-sm font-medium text-white bg-[#DC0000] rounded-r-lg border border-2 border-[#DC0000] hover:bg-[#850000] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <div class="flex flex-row gap-[1vw] w-max items-center justify-center">
            ...
            <select id="countries" class="w-[10vw] bg-[#FFDB89] border border-[#FFDB89] text-[#850000] font-bold text-sm rounded-[10px] border-2 focus:ring-[#DC0000] focus:border-[#DC0000] block w-full p-[1vw]">
    ...
    <div class="w-full flex flex-row items-center justify-center p-[2vw]">
        <ul class="inline-flex items-center -space-x-px">
            <li>
                <a href="#" class="block px-3 py-2 ml-0 leading-tight text-[#850000] bg-white border border-[#850000] rounded-l-lg hover:bg-gray-100 hover:text-[#DC0000] dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <li>
                <a href="#" aria-current="page" class="z-10 px-3 py-2 leading-tight text-white font-bold border border-2 border-[#850000] bg-[#850000] hover:bg-[#850000] hover:text-white dark:border-gray-700 dark:bg-gray-700 dark:text-white">1</a>
            </li>
            <li>
                <a href="#" class="px-3 py-2 leading-tight text-[#850000] bg-white border border-2 border-[#850000] hover:bg-[#850000] hover:text-white dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">2</a>
            </li>
            <li>
                <a href="#" class="px-3 py-2 leading-tight text-[#850000] bg-white border border-2 border-[#850000] hover:bg-[#850000] hover:text-white dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">3</a>
            </li>
            <li>
                <a href="#" class="px-3 py-2 leading-tight text-[#850000] bg-white border border-2 border-[#850000] hover:bg-[#850000] hover:text-white dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">4</a>
            </li>
            <li>
                <a href="#" class="px-3 py-2 leading-tight text-[#850000] bg-white border border-2 border-[#850000] hover:bg-[#850000] hover:text-white dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">5</a>
            </li>
            <li>
                <a href="#" class="block px-3 py-2 ml-0 leading-tight text-[#850000] bg-white border border-[#850000] rounded-r-lg hover:bg-gray-100 hover:text-[#DC0000] dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
