    ...
    <div class="py-24 px-10">
        <div class="content_VirtualAccount">
            ...
            <div class="container-md border-2 border-[#850000] mt-14 rounded flex">
                <div class="w-1/4 border kiri py-4">
                    <div class="selimut ">
                        <div class="kotakCari text-center">
                            <input type="text" placeholder="Cari..." class="border border-solid border-gray-400 rounded-md px-4 py-2 w-1/2 placeholder-gray-500 sm:w-80 sm:placeholder-gray-400 lg:w-96 lg:placeholder-gray-300">
                        </div>
                        <div class="my-10 border border-solid border-gray-200 mb-16"></div>
                        <p>yoooo</p>
                    </div>
            ...
            <div class="flex flex-row h-full w-full overflow-x-hidden">
                <div class="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
                    <div class="flex flex-row items-center justify-center h-12 w-full">
                        <input type="text" placeholder="Cari..." class="border border-solid border-gray-400 rounded-md px-4 py-2">
                    </div>
                    <div class="flex flex-col mt-8">
                        ...
                        <div class="flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto">
                            ...
                            <div class="ml-2 text-sm font-semibold">Natfood Catering</div>
                            </button>
                            <button
