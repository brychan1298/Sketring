...
<div class="mx-auto container-md">
    <div class="px-10 py-24">
        ...
        <div class="flex h-[750px] antialiased text-gray-800 border-4 border-solid border-[#850000] rounded-xl mt-8">
                                    ...
                                    <div class="col-start-1 col-end-8 px-3 rounded-lg">
                                        <div class="flex flex-row items-center">
                                            <div class="relative px-4 py-2 ml-3 text-sm bg-gray-200 shadow rounded-xl">
                                                <div class="text-lg">Kak jadi kah pesanannya?</div>
                                                    <div class="absolute bottom-0 right-0 mr-2 -mb-8 text-base text-gray-500">
                                                        09.30 | Hari ini
                                                    </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-start-6 col-end-13 p-3 rounded-lg">
                                        <div class="flex flex-row-reverse items-center justify-start">
                                            <div class="relative px-4 py-2 mr-3 text-sm bg-[#850000] text-white shadow rounded-xl">
                                                ...
                                                <div class="absolute bottom-0 left-0 mr-2 -mb-8 text-base text-gray-500">
                                                    12.30 | Hari ini
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="flex flex-row items-center w-full h-16 px-4 rounded-xl">
                            <div class="flex-grow ml-4">
                                <div class="relative w-full">
                                    <input type="text" placeholder="Ketik Pesan..." class="flex w-full h-12 pl-4 border-2 border-gray-300 rounded-xl focus:outline-none focus:border-gray-500"/>
