...
<div class="container m-auto mt-[130px]">
    ...
    <div class="flex flex-col pb-6 mx-12 md:mx-24 lg:mx-32" id="tarikSaldoForm">
        ...
        <form action="" method="POST">
            @csrf
            @method('put')
            <input type="text" id="rekening" placeholder="No Rekening" class="w-4/5 p-2 my-12 text-lg border-b-2 border-gray-400 outline-none 2xl:w-1/3 md:w-3/5 lg:w-2/5 focus:border-black">
            <input type="number" id="nominal" min="0" name="nominal" placeholder="Rp Jumlah" class="w-4/5 p-2 my-8 text-lg border-b-2 border-gray-400 outline-none 2xl:w-1/3 md:w-3/5 lg:w-2/5 focus:border-black">
        </form>

    </div>

    <div class="flex justify-center my-10">
        <button type="submit" class="px-4 px-8 py-2 text-xl font-bold text-white bg-red-600 rounded hover:bg-red-800">
            TARIK
        </button>
    </div>
</div>
