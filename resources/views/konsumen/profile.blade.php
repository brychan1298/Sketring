...
@section('content')
    <div class="container-md mx-auto flex flex-col mt-[140px] w-full">
        ...
        <div class="container-md xl:flex xl:flex-row justify-center gap-[32px] w-full px-[48px] pb-[48px]">
            ...
            <div
                class="bg-[#850000] xl:w-[75%] md:w-[100%] text-white flex flex-col gap-[16px] items-center p-[32px] rounded-[10px]">
                <div class="w-[100%] flex flex-row-reverse">
                    <a href="/editprofile" class="flex flex-row w-max">
                        <div
                            class="flex flex-row bg-white w-max text-[#DC0000] gap-[16px] items-center p-[16px] rounded-[10px]">
                            <p class="font-bold">SUNTING</p>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#DC0000"
                                viewBox="0 0 16 16">
                                <path
                ...
                <div class="flex flex-col gap-[16px] ">
                    @if (Auth::User()->FotoProfil)
                        <img class="rounded-full w-[360px] h-[360px]" src="{{ asset('storage/' . Auth::User()->FotoProfil) }}"
                            alt="">
                    @else
