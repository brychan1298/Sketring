<div
    ...
    <a href="/konsumen/pesanan" class="{{ set_active_pesanan_2('pesanan') }} text-white border-white mx-1.5 sm:mx-6 group transition duration-200">
        Belum Bayar
        <span class="{{ set_active_pesanan('pesanan') }} block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-[white]"></span>
    </a>
    ...
    <a href="/konsumen/disiapkan"
        ...
        Disiapkan
        <span class="{{ set_active_pesanan('pesanan-disiapkan') }} block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-[white]"></span>
    </a>
    ...
    <a href="/konsumen/dikirimkan"
        ...
        Dikirimkan
        <span class="{{ set_active_pesanan('pesanan-dikirimkan') }} block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-[white]"></span>
    </a>
    ...
    <a href="/konsumen/selesai"
        ...
        Selesai
        <span class="{{ set_active_pesanan('pesanan-selesai') }} block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-[white]"></span>
    </a>
    ...
    <a href="/konsumen/dibatalkan"
        ...
        Dibatalkan
        <span class="{{ set_active_pesanan('pesanan-dibatalkan') }} block max-w-0 group-hover:max-w-full transition-all duration-500 h-0.5 bg-[white]"></span>
    </a>
