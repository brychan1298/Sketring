...
<div class="container m-auto mt-[100px]">
    <div class="flex items-center justify-center judulAddProduk">
        ...
        <h2 class="text-4xl font-black textJudul">Detail Pesanan</h2>
    </div>

    <hr class="my-8">

    <div class="mx-28 my-14">
        <div class="flex justify-between atas">
        ...
        <div class="listPesanan">
            <div id="pesanan" class="flex justify-between my-5">
                <img src="https://source.unsplash.com/200x200/?web-programming" class="mr-5 rounded-lg">
                <div class="flex items-center justify-between w-4/5 detailProduk">
                    <div class="detail1">
        ...
        <div class="flex justify-end my-6">
            <button class="px-4 px-8 py-2 mx-2 text-xl font-semibold text-red-600 bg-transparent border border-red-600 rounded hover:bg-red-800 hover:text-white hover:border-transparent">
                TOLAK
            </button>
