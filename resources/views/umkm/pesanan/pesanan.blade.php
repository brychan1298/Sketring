...
@section('content')
    <div class="container flex flex-col items-center w-full mx-auto px-36 max-lg:px-12">
        ...
        @if (session()->has('Delete'))
            <div id="alert"
                class="relative flex px-4 py-3 mt-32 -mb-24 text-red-700 border border-red-700 rounded bg-warning alert alert-success"
                role="alert">
                <span>
                    {{ session('Delete') }}
                </span>
            ...
            <div class="w-full">
                ...
                <div class="bg-white shadow-xl flex flex-col mb-8 p-8 rounded-[10px]">
                    ...
                    @foreach ($items as $Transaksi)
                        ...
                        <div class="w-full h-[2px] bg-[#850000]"></div>
                    @endforeach
                    <div class="flex flex-col w-max items-end self-end max-sm:items-center max-sm:self-center gap-[0.5vw] justify-center mt-5">
                        <div class="flex flex-row w-max gap-[1vw] font-bold float-right">
                            ...
                            <form action="/umkm/terima-pesanan/{{ $Transaksis }}" method="get">
                                ...
                                <button type="button"
                                    class="btnTerimaPesanan text-white bg-[#DC0000] border border-2 border-[#DC0000] px-4 py-2 text-sm rounded-md hover:bg-[#850000] hover:border-[#850000]">
                                    TERIMA
                                </button>
                            </form>
                        </div>
