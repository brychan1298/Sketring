            ...
            <div class="flex flex-col justify-between atas lg:flex-row">
                <div class="tokoTanggal">
                    ...
                    <div class="flex items-center my-3 tanggal">
                        ...
                        <h2 id="tanggalPesanan" class="mx-3 text-xl font-bold">{{ $TanggalPesanan }}</h2>
                    </div>
                    ...
                    <div class="justify-between my-5 lg:flex">
                        ...
                        <div class="flex items-center justify-between w-full detailProduk">
                            ...
                            <div class="py-10 detail2">
                                <h2 class="text-2xl text-end">Total:</h2>
            ...
            @if ($statusView == 'sudahbayar')
                <div class="flex justify-center my-16 md:justify-end">
                    <form action="/umkm/tolak-pesanan/{{ $IdTransaksi }}" method="POST">
                        ...
                        <button type="button"
                            class="px-8 py-2 mx-2 text-xl font-semibold text-red-600 bg-transparent border border-red-600 rounded btnTolakPesanan hover:bg-red-800 hover:text-white hover:border-transparent">
                            TOLAK
                        </button>
                    </form>
                    <form action="/umkm/terima-pesanan/{{ $IdTransaksi }}" method="get">
                        ...
                        <button type="button"
                            ...
                            class="px-8 py-2 text-xl font-bold text-white bg-red-600 rounded btnTerimaPesanan hover:bg-red-800">
                            TERIMA
                        </button>
                    </form>
                </div>
            ...
            @if ($statusView == 'disiapkan')
                <div class="flex justify-center my-16 md:justify-end">
                    <a href="/umkm/chat/{{ $DataTransaksiUser->IdUser }}"
                        class="px-4 px-8 py-2 mx-2 text-xl font-semibold text-red-600 bg-transparent border border-red-600 rounded hover:bg-red-800 hover:text-white hover:border-transparent">
                        CHAT
                    </a>
