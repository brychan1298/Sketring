...
@section('content')
    ...
    <form action="update" enctype="multipart/form-data" method="post">
            ...
            <div class="w-full">
                <div class="text-center w-fit max-lg:mx-auto">
                    @if (Auth::User()->FotoProfil)
                        <img src="{{ asset('storage/' . Auth::User()->FotoProfil) }}" alt="SyamsulKatering.id"
                            class="-mt-40 rounded-full w-80 h-80 max-lg:w-52 max-lg:h-52 max-lg:-mt-28 max-sm:-mt-20 max-sm:text-center max-sm:w-40 max-sm:h-40 img-preview">
                    @else
                        <img src="/images/fotoprofile_default.png" alt="SyamsulKatering.id"
                            class="-mt-40 rounded-full w-80 h-80 max-lg:w-52 max-lg:h-52 max-lg:-mt-28 max-sm:-mt-20 max-sm:text-center max-sm:w-40 max-sm:h-40 img-preview">
                    @endif
                    <label for="FotoProfil">
                        <div
                            class="opacity-0 hover:opacity-100 flex flex-col items-center justify-center absolute bg-[black] w-80 h-80 rounded-full bg-opacity-50 -mt-80 max-lg:w-52 max-lg:h-52 max-sm:w-40 max-sm:h-40 max-lg:-mt-52 max-sm:-mt-40">
                            <svg class="text-center max-lg:w-52 max-md:w-14" width="80" height="72"
                                viewBox="0 0 80 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <div
                                class="px-10 mt-4 text-4xl font-black text-center text-white max-lg:text-xl max-sm:text-base max-md:px-4">
                                GANTI FOTO PROFIL
                            </div>
                        </div>
                    </label>
        ...
        <a href="/umkm/profileToko" class="flex flex-row w-max">
            ...
            <div
                class="container-md flex flex-row justify-center w-full mt-12 gap-16 pb-[48px] max-xl:gap-12 max-lg:gap-8 max-md:grid max-md:grid-cols-1">
            ...
            <div class="bg-[#FFE6AE] p-[24px] flex flex-col rounded-[10px] gap-[12px] ml-16 max-lg:ml-0">
                ...
                <div
                    class="bg-[#850000] w-9/12 text-white flex flex-col gap-[2.5vw] items-center p-[3vw] rounded-[10px] max-md:w-full max-md:p-6 max-md:gap-6">
                    <div class="w-[100%] flex flex-col gap-[8px]">
                        ...
                        <input type="text" name="Nama"
                            class="max-md:text-base px-[24px] py-[16px] text-black bg-white rounded-[10px] text-lg"
                            placeholder="Masukan Nama Lengkap Anda" value="{{ Auth::User()->Nama }}">
                    </div>
                    <div class="w-[100%] flex flex-col gap-[8px]">
                        <div class="w-[100%] flex flex-row gap-[1vw] items-center">
                        ...
                        <textarea name="Alamat" class="max-md:text-base px-[24px] py-[16px] text-black bg-white rounded-[10px] text-lg"
                    ...
                    <div class="w-[100%] flex flex-col gap-[8px]">
                        ...
                        <input type="text" name="jam"
                            class="max-md:text-base px-[24px] py-[16px] text-black bg-white rounded-[10px] text-lg"
                            placeholder="Masukan Jam Operasional" value="06.00 - 21.00">
                    </div>
                    <div class="w-[100%] flex flex-col gap-[8px]">
                        <div class="w-[100%] flex flex-row gap-[1vw] items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <div class="w-[100%] flex flex-col gap-[8px]">
                        ...
                        <select required id="kota-dropdown"
                            class="max-md:text-base px-[24px] py-[16px] text-black bg-white rounded-[10px]"
                            name="IdKota">
                        </select>
                    </div>
                    <div class="w-[100%] flex flex-col gap-[8px]">
                    ...
                    <div class="w-[100%] flex flex-col gap-[8px]">
                        ...
                        <input type="no_telepon" name="Nohp"
                            class="max-md:text-base px-[24px] py-[16px] text-black bg-white rounded-[10px] text-lg"
                            placeholder="Masukan Nomor Telepon" value="{{ Auth::User()->Nohp }}">
                    </div>
                </div>
            </div>
            <div class="flex justify-center gap-5 mb-16">
                <a href="/umkm/profileToko"
                    class="max-md:text-lg font-bold border-2 border-solid border-[#DC0000] text-[#DC0000] text-2xl px-7 py-2 my-5 rounded-md hover:text-[#850000] hover:border-[#850000]">
                    BATAL
                </a>
                <button type="submit"
                    class="max-md:text-lg border-2 text-white bg-[#DC0000] px-7 py-2 text-2xl rounded-md my-5 hover:bg-[#850000] hover:text-white">
                    SIMPAN
                </button>
            </div>
        </div>
