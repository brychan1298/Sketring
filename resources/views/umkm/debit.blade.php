    ...
    <div class="flex flex-col pb-6" id="tarikSaldoForm">
        ...
        <form action="/tarikSaldoDebitUMKM/{{ Auth::User()->IdUser }}" method="POST">
            ...
            <div class="flex flex-col items-center">
                <input type="text" id="virtualAccount" placeholder="No Rekening" class=" p-2 my-12 text-lg border-b-2 border-gray-400 outline-none w-4/5 2xl:w-1/3 md:w-3/5 lg:w-2/5 focus:border-black" required>
