...
<div class="container m-auto mt-[100px]">
    <div class="rounded-md shadow-3xl py-10">
        ...
        <h1 class="font-normal text-3xl mt-3 text-center ">
            Halo, <label class="font-black">SyamsulKatering.id</label>
        </h1>
        ...
        <div>
            ...
            <div class="grid grid-cols-3 gap-5 mt-12">
                <div class="rounded-md shadow-3xl">
                    <img src="images/secure.png" alt="" class="w-[12vw] h-[8.8vw]">
                    <div class="p-4">
            ...
            <div class="mt-5">
                <button class="bg-[#850000] text-white py-2 px-10 rounded-md">
                    Selengkapnya
                </button>
            </div>
        </div>
